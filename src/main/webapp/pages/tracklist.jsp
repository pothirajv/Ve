...
<script type="text/javascript" src="<%=request.getContextPath() %>/js/tracklist.js?v=1.1"></script>
								...
								<div class="col-md-6 mr-auto">
									<div class="row">
										...
										<div class="col-md-6 form-group">
											...
											<input type="text" class="dateSearch" id="from_date_id" placeholder="Ex. YYYY-MM-DD" autocomplete="off"> 
											<div class="validation"></div>
										</div>
										<div class="col-md-6 form-group">
											<label for="pickdrop" class="periodDayLblCls">To Date</label><br> 
											<input type="text" class="dateSearch" id="to_date_id" placeholder="Ex. YYYY-MM-DD" autocomplete="off">
											<div class="validation"></div>
										</div>
									</div>
								</div>
...
<!-- 								</div> -->
						...
						<div class="col-md-12" style="margin-top: 50px;">
							<table id="senderdetails" class="table table-striped table-bordered dataTable no-footer"></table>
							<div class="row">
								<div class="col-md-12">
									<button class="btn btn-primary" id="sender_report" style="float: right; margin-top: 20px; display: none;">
