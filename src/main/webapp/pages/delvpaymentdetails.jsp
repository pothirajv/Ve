...
<script type="text/javascript" src="<%=request.getContextPath() %>/js/delvpaymentdetails.js"></script>
					...
					<div class="row formcls srchCls" style="margin-top: 0px;">
						<div class="col-md-12 mr-auto">
							<h5 class="font-weight-bold">
								<span>Settlement To Deliverer</span>
							</h5>
						</div>
				...
				<div class="mainContentCls1" style="margin-top: 10px; display: none;">
					<div class="col-md-12 row mr-auto">
						<h5 class="font-weight-bold" style="color: #e91e63;">
							...
							<span id="userNameFrm"></span> (<label id="roleNameFrm"></label>)
						</h5>
					</div>
						...
						<div class="col-md-12 form-group">
							<table class="defTbl" style="">
								<tr>
									...
									<td class="travelDisMainCls" style="width: 220px;">
										<span id="totAmntFrm" style="display: none;"></span>
										<span style="font-weight: bold;"><label for="pickdrop" class="hdrLblCls totGstLbl">Total Travel Distance</label> (Km)</span><br> 
										<label id="totRiderTravelDistHdr">0</label>
									</td>
									<td class="totDelvAmntCls" style="width: 220px;">
									...
									<td style="width: 220px;">
										<span style="font-weight: bold;"><label for="pickdrop" class="hdrLblCls totCmmsnAllowLbl">Total Rider Commission</label> (<span class="fa fa-inr inrCls"></span>)</span><br> 
										<label id="totCmmsnAllowHdr">0</label>
									</td>
									<!-- <td>
						...
						<div class="row formcls payFormCls">
							<div class="col-md-12 form-group" style="margin-top: 10px; margin-bottom: 0px;">
								<div class="row formcls">
									...
									<div class="col-md-3 form-group">
										<label for="pickdrop" class="hdrLblCls required-label">Amount Paid</label><br> 
